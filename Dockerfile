...
RUN sudo /etc/init.d/postgresql start && python3 Praktomat/src/manage-local.py collectstatic --noinput --link && python3 Praktomat/src/manage-local.py migrate --noinput
